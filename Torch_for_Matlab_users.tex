...
\begin{tabular}{|p{\frstClmnWidth{}}|p{\scndClmnWidth{}}|}
\hline
\textbf{Matlab} & \verb!testVar2 = testVar1;! \\ \hline
\textbf{Torch} & \verb!testVar2 = testVar1;! \\ \hline
\end{tabular}
\\

\noindent The value of \verb!testVar1! variable (3.2333) is assigned to \verb!testVar2! variable.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\noindent Matlab internally handles memory assignment for a copied array. As soon, as the copied array is changed in Matlab, a copy of the initial array is generated. Whereas, Torch gives this option to have a copied tensor that points to the same location in the memory as the initial tensor. For example, if elements of \verb!matOut! are modified here, the same changes happen to the elements of the \verb!matIn!.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\noindent Matlab's internal memory handling for array assignment is usually closer to this. Here, Torch generates a copy of the array contents in memory. Any changes in \verb!matOut! elements are independent of the changes in the elements of the \verb!matIn!.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection*{Square root of elements:}
...
\noindent \verb!matIn:sqrt()! is same as \verb!matIn.sqrt(matIn)!. Generally in Lua, \verb!object:function(p1, p2, ...)! is same as\\ \verb!object.function(object, p1, p2, ...)!, where the function's object is passed as the first hidden input. 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\noindent Each element of \verb!matIn! to the power of the corresponding element of \verb!matPow! is saved in an output tensor with the same size as the input tensor.
